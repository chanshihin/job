...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- moving tap -->
<button style = "width: 33%;"class="tablink" onclick="location.href='laptop.php'" >APPLE</button>
<button style = "width: 33%;"class="tablink" onclick="location.href='lenovolaptop.php'">LENOVO</button>
<button style = "width: 33%;"class="tablink" onclick="location.href='asuslaptop.php'">ASUS</button><br>
